...
class Constraints : public SubjectTo {
 ...
 public:
  Constraints() = delete;
  Constraints(int n, /**< Number of constraints. */
              int indexlist_size);
  ...
  returnValue moveActiveToInactive(
      int _number /**< Number of constraint to become inactive. */
  );
   ...
   *  \return SUCCESSFUL_RETURN */
  inline returnValue setNEC(
      int n /**< Number of implicit equality constraints. */
  );

  /** Sets number of "real" inequality constraints.
   *  \return SUCCESSFUL_RETURN */
  inline returnValue setNIC(
      int n /**< Number of "real" inequality constraints. */
  );

  /** Sets number of unbounded constraints (i.e. without any bounds).
   *  \return SUCCESSFUL_RETURN */
  inline returnValue setNUC(
      int n /**< Number of unbounded constraints (i.e. without any bounds). */
  );
